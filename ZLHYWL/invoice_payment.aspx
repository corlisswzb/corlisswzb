<%@ Page Title="" Language="C#" MasterPageFile="~/main_page.Master" AutoEventWireup="true" CodeBehind="invoice_payment.aspx.cs" Inherits="Jbfd.invoice_payment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <div class="easyui-tabs" id="dv_tabs" data-options="border:false,fit:true">
        <div title="应付发票管理" data-options="closable:false" style="padding: 5px">
