<%@ Page Title="" Language="C#" MasterPageFile="~/main_page.Master" AutoEventWireup="true" CodeBehind="ld_query_fee_cu_group.aspx.cs" Inherits="Jbfd.ld_query_fee_cu_group" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="easyui-layout" fit="true"  style="padding:0px" >  
            ...
            <div  class="easyui-panel custom_bg" data-options="fit:true,border:false,title:''" style=" border-bottom:solid 1px #95b8e7;" >
                <table class="tab_std" style="width:auto;  ">
                    <tr>    
                        ...
                        <td>
                            <a href="javascript:refresh_rpt_of_fee_cu_group();" tabindex="1" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-query'">查询</a>
                            <a href="javascript:download_fee_cu_group();" tabindex="1" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-20130406125519344_easyicon_net_16'">下载</a>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div data-options="region:'center',split:false,border:false" style="padding:0px"> 
            <div  class="easyui-panel" data-options="fit:true,border:false,title:''">
                <table id="tab_fee_cu_group"></table>
            </div> 
        </div> 
    </div>
    <!--关联委托查看-->
    ...
    <div id="mm_of_datagrid" class="easyui-menu" style="width: 240px; display: none;">  
       <!--放置一个隐藏的菜单Div-->  
        ...
        <div   data-options="iconCls:'icon-view'" onclick="win_view_of_order_fee_list()">查看关联费用明细</div> 
    </div> 
</asp:Content>
