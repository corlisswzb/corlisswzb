<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="template_order_fee_pay_fo_bus_focus.aspx.cs" Inherits="ZLHYWL.template_order_fee_pay_fo_bus_focus" %>
...
<script src="Js/template_order_fee_pay_for_bus_of_focus.js"></script>
...
<body  style="width:100%;height:100%; overflow:hidden;  padding:0px; margin:0px;">
    <div class="easyui-layout" data-options="fit:true" style="padding:0px">
        <div data-options="region:'north',split:false,border:false" class="custom_bg" style="border-bottom:solid 1px #95b8e7;">
            <table class="tab_std" style="width:auto;  ">
                <tr> 
                    <td>
                        <a href="javascript:show_win_of_group_order_fee();" tabindex="1" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-query'">应付待归账</a> 
                    </td>
                    <td>
        ...
        <div data-options="region:'south',split:false,border:false" style="  height:26px;  "  class="custom_bg">
    ...
    <!--未归账费用汇总-->
    <div id="win_of_group_order_fee" class="easyui-window" title="应付待归账汇总表" data-options="modal:true,closed:true,iconCls:'icon-save'" 
        style="width:650px;height:450px;padding:0px;">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'center',split:false,border:false">
                <table id="tab_group_fee_list"></table>
            </div>
            <div data-options="region:'south',split:false,border:false" style=" height:58px;  " class="custom_bg" >
    ...
    <div id="dlg_choise_ca_main" class="easyui-dialog" style="padding:0px;">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'north',border:false,split:false" style=" height:98px" class="custom_bg">
