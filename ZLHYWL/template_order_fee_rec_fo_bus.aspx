<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="template_order_fee_rec_fo_bus.aspx.cs" Inherits="ZLHYWL.template_order_fee_rec_fo_bus" %>
...
<script src="Js/template_order_fee_rec_for_bus_of_normal.js"></script>
...
<body style="width:100%;height:100%; overflow:hidden;  padding:0px; margin:0px;">
    <div class="easyui-layout" data-options="fit:true" style="padding:0px">
        <div data-options="region:'north',split:false,border:false" class="custom_bg" style=" border-bottom:solid 1px #95b8e7;height:120px; ">
