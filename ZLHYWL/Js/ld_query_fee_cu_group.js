...
var cur_query_fee_cu_group_params = undefined;
...
//刷新
function refresh_rpt_of_fee_cu_group() {
    cur_query_fee_cu_group_params = {
        rnd: Math.random(),
        action: 'get_rpt_of_fee_cu_group',
        ...
        fee_cu_id: $('#search_fee_cu_id').combobox('getValue'),
       
    };
    cur_query_sub_params = $.extend(true,{},cur_query_fee_cu_group_params);
 


    //只有月没有年，是不允许的 
    if (cur_query_fee_cu_group_params.beg_month != undefined && Number(cur_query_fee_cu_group_params.beg_month) > 0) {
        if (cur_query_fee_cu_group_params.beg_year == undefined ||
            Number(cur_query_fee_cu_group_params.beg_year) == 0) {
            $.messager.alert('错误','错误:无法理解的起始时间设置!','error');
            return;
        }
    }
    if (cur_query_fee_cu_group_params.end_month != undefined && Number(cur_query_fee_cu_group_params.end_month) > 0) {
        if (cur_query_fee_cu_group_params.end_year == undefined ||
            Number(cur_query_fee_cu_group_params.end_year) == 0) {
            $.messager.alert('错误', '错误:无法理解的截止时间设置!', 'error');
            return;
        }
    }
    if (cur_query_fee_cu_group_params.rec_or_pay == undefined  ) {
        $.messager.alert('错误', '错误:无法理解的收付设置!', 'error');
        return;
    }

    if (cur_query_fee_cu_group_params.rec_or_pay == 1) {
        $("#tab_fee_cu_group").datagrid('hideColumn', 'sum_of_pay_amount');
        $("#tab_fee_cu_group").datagrid('hideColumn', 'sum_of_payed_amount');
        $("#tab_fee_cu_group").datagrid('hideColumn', 'sum_of_unpayed_amount');
        $("#tab_fee_cu_group").datagrid('showColumn', 'sum_of_rec_amount');
        $("#tab_fee_cu_group").datagrid('showColumn', 'sum_of_reced_amount');
        $("#tab_fee_cu_group").datagrid('showColumn', 'sum_of_unreced_amount');
    } else {
        $("#tab_fee_cu_group").datagrid('showColumn', 'sum_of_pay_amount');
        $("#tab_fee_cu_group").datagrid('showColumn', 'sum_of_payed_amount');
        $("#tab_fee_cu_group").datagrid('showColumn', 'sum_of_unpayed_amount');
        $("#tab_fee_cu_group").datagrid('hideColumn', 'sum_of_rec_amount');
        $("#tab_fee_cu_group").datagrid('hideColumn', 'sum_of_reced_amount');
        $("#tab_fee_cu_group").datagrid('hideColumn', 'sum_of_unreced_amount');
    }

    post('../Ashx/lead_query.ashx', cur_query_fee_cu_group_params,
    function (data) {
        $("#tab_fee_cu_group").datagrid('loadData', data);
        $("#tab_fee_cu_group").datagrid('reloadFooter', [
        {
            cu_name: '', 
            order_count: '', 
...
//初始表格
function init_tab_fee_cu_group() { 
    cur_query_fee_cu_group_params = {
        rnd: Math.random(),
        action: 'get_rpt_of_fee_cu_group',
        rec_or_pay: $('#search_rec_or_pay').combobox('getValue'),
    ...
    $("#tab_fee_cu_group").datagrid({
        ...
        checkOnSelect: true,
        columns: [[
            { field: 'cu_name', title: '结算单位', align: 'center', width: 110, },
            { field: 'order_count', title: '涉单数', align: 'center', width: 70 },
            { field: 'sum_of_cargo_weight', title: '货重', align: 'center', width: 90 },
            { field: 'sum_of_cargo_packing_number', title: '件数', align: 'center', width: 90 },
            { field: 'sum_of_cargo_bluk', title: '体积', align: 'center',width: 90  },
        ...
        onRowContextMenu: function (e, field, row) {
            e.preventDefault();
            $('#mm_of_datagrid').data('fee_cu_id', row.cu_id);
            $('#mm_of_datagrid').data('cu_name', row.cu_name);
...
function download_fee_cu_group() {
    var down_query_sub_params = $.extend(true,{}, cur_query_fee_cu_group_params);
    down_query_sub_params.action = 'download_rpt_of_fee_cu_group';
...
function win_view_of_order_list() {
    cur_query_sub_params.fee_cu_id = $('#mm_of_datagrid').data('fee_cu_id');
    cur_query_sub_params.action = 'get_rpt_of_fee_cu_group_of_order_list';
...
function download_order_group() {
    ...
    down_query_sub_params.action = 'download_rpt_of_fee_cu_group_order_list';
...
function win_view_of_order_fee_list(rec_or_pay) {
    ...
    cur_query_sub_params.fee_cu_id = $('#mm_of_datagrid').data('fee_cu_id');
    cur_query_sub_params.action = 'get_rpt_of_fee_cu_group_of_fee_list';
...
function download_order_fee_group() {
    var down_query_sub_params = $.extend(true, {}, cur_query_sub_params);
    down_query_sub_params.action = 'download_rpt_of_fee_cu_group_order_fee';
    window.open('../Ashx/lead_query.ashx?' + parseParams(down_query_sub_params));
}
...
function win_view_of_order_cntr_list() {
    cur_query_sub_params.fee_cu_id = $('#mm_of_datagrid').data('fee_cu_id');
    cur_query_sub_params.action = 'get_rpt_of_fee_cu_group_of_cntr_list';
    cur_query_sub_params.delete_name = $('#mm_of_datagrid').data('cu_name');
    post('../Ashx/lead_query.ashx', cur_query_sub_params,
    function (data) {
...
function download_order_cntr_group() {
    var down_query_sub_params = $.extend(true, {}, cur_query_sub_params);
    down_query_sub_params.action = 'download_rpt_of_fee_cu_group_order_cntr';
    window.open('../Ashx/lead_query.ashx?' + parseParams(down_query_sub_params));
}