...
function init_tab_order_fee_group() {
    ...
    $("#tab_order_fee_group").datagrid({
        ...
        columns: [[
                ...
                { field: 'fee_amount', title: '总金额', rowspan: 3, align: 'center' },
                { title: '已销账', colspan: 3, align: 'center' },
                { title: '未销账', colspan: 3, align: 'center' },
                { field: 'fee_amount_of_uncommit', title: '小计', rowspan: 3, align: 'center' },
                { field: 'fee_amount_of_uncommit_of_noneinvoice', title: '不需票', rowspan: 3, align: 'center' },
                { field: 'fee_amount_of_uncommit_of_invoice', title: '需票', rowspan: 3, align: 'center' },
                ...
                { field: 'woa_total_money', title: '小计', rowspan: 2, align: 'center' },
                { field: 'woa_total_money_of_noneinvoice', title: '不需票', rowspan: 2, align: 'center' },
                { field: 'woa_total_money_of_invoice', title: '需票', rowspan: 2, align: 'center' },
                { field: 'unwoa_total_money', title: '小计', rowspan: 2, align: 'center' },
                { field: 'unwoa_total_money_of_noneinvoice', title: '不需票', rowspan: 2, align: 'center' },
                { field: 'unwoa_total_money_of_invoice', title: '需票', rowspan: 2, align: 'center' },
