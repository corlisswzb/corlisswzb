...
$(document).ready(function () {
    ...
    $("#btn_sure").click(function () {
        ...
        var rows = $("#tab_sy_fee").datagrid("getSelections");
        //选择的行
        if (rows.length > 0) {
...
function bind_cbx_customer() {
   ...
   function (data) {
       ...
       $('#ipt_yskh').combobox({
           ...
           onClick: function (item) {
               ...
               if (params.cuid == "") {
                   ...
                   $("#tab_ys_custom").datagrid('clearSelections');
                   init_tab_ys_custom();
       ...
       bind_combobox(data.rows, $('#ipt_yskh'), 'cu_name', 'cu_id', true);
   })
...
function init_tab_ys_custom() {
    params.action = "get_customer_table";

    $("#tab_ys_custom").datagrid({
        ...
        onClickRow: function (rowIndex, rowData) {
            ...
            $("#ipt_yskh").combobox("setValue", rowData.cu_id);
            init_tab_ys_fee();
        }
...
function init_tab_ys_fee() {
             ...
             },
             {
                 ...
                 styler: function (value, row, index) {
                     if (value == 0) {
                         ...
                         return "background-color:#F8961E;cursor: pointer;";
                     }  else if (value == 4) {
                         return "background-color:#90BE6D;cursor: pointer;";
                     }  else if (value == 6) {
    ...
    $.getJSON('/Ashx/reconciliation_mgr.ashx', params, function (data) {
        ...
        $("#tab_sy_fee").datagrid("loadData", virData);
    })
