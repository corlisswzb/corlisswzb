<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="template_order_fee_pay_fo_operation.aspx.cs" Inherits="ZLHYWL.template_order_fee_pay_fo_operation" %>
...
<script src="Js/template_order_fee_pay_for_operation_of_normal.js"></script>
        ...
        <div data-options="region:'north',split:false,border:false" class="custom_bg" style=" border-bottom:solid 1px #95b8e7;">
            <table class="tab_std" style="width:auto;  ">
                ...
                <tr>
                    ...
                    <%--<td class="value" style="text-align:center; vertical-align:middle;" colspan="2">
                        <label for="search_fee_invoice_lock_flag">无票销账</label><input type="checkbox" id="search_fee_invoice_lock_flag" />
                    </td>  --%>
                    <td>
