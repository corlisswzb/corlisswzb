<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="template_order_fee_pay_fo_bus.aspx.cs" Inherits="ZLHYWL.template_order_fee_pay_fo_bus" %>
...
<script src="Js/template_order_fee_pay_for_bus_of_normal.js"></script>
...
<body style="width:100%;height:100%; overflow:hidden;  padding:0px; margin:0px;">
    <div class="easyui-layout" data-options="fit:true" style="padding:0px">
        <div data-options="region:'north',split:false,border:false" class="custom_bg" style=" border-bottom:solid 1px #95b8e7;height:120px; overflow:hidden;">
            <table class="tab_std" style="width:auto;  ">
                <tr> 
                    ...
                    <td class="value">
                        <select id="search_fee_status" class="easyui-combobox" data-options="multiple: true, editable:false,panelHeight:'auto',valueField:'value', textField:'label',filter: filterCombo,width:106" >
                            ...
                            <option value="3">交账待付</option> 
                            <option value="4">部分付款</option> 
                            <option value="9">已付讫</option>  
                        </select>
                    </td>
                    <td class="title">
                        业务类型:
                    ...
                    <td class="value" colspan="3"> 
                        <input id="search_fee_cu_id" class="easyui-textbox cls_customs_combogrid" style="width:282px;height:24px;line-height:20px;padding:0 2px;" />  
                                
                    </td> 
                            
                    <td class="title">业务(起):</td>
                    <td class="value">
                    ...
                    <td class="title">录单人:</td>
                    <td class="value"> 
                        <select id="search_fee_record_id" class="easyui-combobox" data-options="multiple: true, editable:false,panelHeight:'200',valueField:'value', textField:'label',filter: filterCombo,width:106" ></select>
                    </td> 
                    <td>
                        <a href="javascript:change_to_focus_model();" tabindex="1" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-award_star_add'">切换到专注模式</a> 
                    </td>          
                </tr> 
                <tr> 
                    <td class="title">
                    ...
                    <td class="value" colspan="3" >
                        <input id="search_od_invoice_no"  class="easyui-textbox" style=" width:274px;height:24px;line-height:20px;padding:0 2px;"  />
                    </td> 
                    
                    <td class="title">金额:</td>
                    <td class="value" >
                        <input id="search_fee_guess_amount" class="easyui-textbox" autocomplete="off" onkeyup="value=value.replace(/[^-\d.]/g,'')" style="width:100px" />
                    </td>  
                    <td >
                ...
                <tr>
                    ...
                    <td class="value" >
                        <input id="search_od_route_tools_desc" class="easyui-textbox" style="width:120px;height:24px;line-height:20px;padding:0 2px;" />
                    </td> 
                    ...
                    <td class="title" style="text-align:left;">提空单号:</td> 
                    <td class="value" colspan="3">
                    ...
                    <%--<td class="value" colspan="3" style="text-align:center; vertical-align:middle;">--%>
                   ...
                   <%-- </td> --%>
                    ...
                    <td>
                       <a href="javascript:open_order_fee_group_window();" tabindex="1" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-query'">汇总查询</a> 
                    </td>          
                </tr>
                <tr>
    ...
    <!--费用汇总-->
    <div id="win_order_fee_group" class="easyui-window" title="应收已交账费用汇总信息" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:1080px;height:600px;padding:0px;">
                ...
                <table class="tab_std" style="width:auto;  ">
                    <tr>  
                        ...
                        <td class="value" colspan="7">
                                <input id="search_win_fee_cu_id" class="cls_customs_combogrid" style="width:420px;" /> 
                        </td>
                        <td class="title">起始年份:</td>
                        <td class="value"> 
                            <select id="search_win_fee_dat_begin_year" class="easyui-combobox" data-options="panelHeight:'auto',valueField:'value', textField:'label',filter: filterCombo,width:76" ></select>
                        </td>
                        <td class="title">起始月份:</td>
                        <td class="value"> 
                            <select id="search_win_fee_dat_begin_month" class="easyui-combobox" data-options="panelHeight:'auto',valueField:'value', textField:'label',filter: filterCombo,width:56" ></select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="value"> 
                            <select id="search_win_service_id" class="easyui-combobox" data-options="panelHeight:'200',panelWidth:'120',valueField:'value', textField:'label',filter: filterCombo,width:56" ></select>
                        </td> 
                        <td class="title">操作:</td>
                        <td class="value"> 
                            <select id="search_win_operation_id" class="easyui-combobox" data-options="panelHeight:'200',panelWidth:'120',valueField:'value', textField:'label',filter: filterCombo,width:56" ></select>
                        </td>
                        <td class="title">销售:</td>
                        <td class="value"> 
                            <select id="search_win_sales_id" class="easyui-combobox" data-options="panelHeight:'200',panelWidth:'120',valueField:'value', textField:'label',filter: filterCombo,width:56" ></select>
                        </td>
                        <td class="title">录费:</td>
                        <td class="value"> 
                            <select id="search_win_record_id" class="easyui-combobox" data-options="panelHeight:'200',panelWidth:'120',valueField:'value', textField:'label',filter: filterCombo,width:56" ></select>
                        </td>
                        <td class="title">截止年份:</td>
                        <td class="value"> 
                            <select id="search_win_fee_dat_end_year" class="easyui-combobox" data-options="panelHeight:'auto',valueField:'value', textField:'label',filter: filterCombo,width:76" ></select>
                        </td>
                        <td class="title">截止月份:</td>
                        <td class="value"> 
                            <select id="search_win_fee_dat_end_month" class="easyui-combobox" data-options="panelHeight:'auto',valueField:'value', textField:'label',filter: filterCombo,width:56" ></select>
                        </td> 
                        <td>
