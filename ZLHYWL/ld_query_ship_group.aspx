<%@ Page Title="" Language="C#" MasterPageFile="~/main_page.Master" AutoEventWireup="true" CodeBehind="ld_query_ship_group.aspx.cs" Inherits="ZLHYWL.ld_query_ship_group" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="Style/checkaccount.css" rel="stylesheet" />
    <script src="Js/ld_query_ship_group.js"></script>
</asp:Content>
            ...
            <div  class="easyui-panel custom_bg" data-options="fit:true,border:false,title:''" style="border-bottom:solid 1px #95b8e7;" >
                <table class="tab_std" style="width:auto;  ">
                    <tr>    
                        ...
                        <td class="value">
                             <input id="search_tools_owner_id" data-cu_id="" class="cls_customs_combogrid" style="width:172px;" /> 
                        </td>--%>
                        ...
                        <td>
                            <a href="javascript:refresh_rpt_of_ship_group();" tabindex="1" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-query'">查询</a>
                            <a href="javascript:download_ship_group();" tabindex="1" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-20130406125519344_easyicon_net_16'">下载</a>
                        </td>
                    </tr>
                </table>
            </div>
