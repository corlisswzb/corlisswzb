<%@ Page Title="" Language="C#" MasterPageFile="~/main_page.Master" AutoEventWireup="true" CodeBehind="ld_query_employee_group.aspx.cs" Inherits="ZLHYWL.ld_query_employee_group" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="Style/checkaccount.css" rel="stylesheet" />
    <script src="Js/ld_query_employee_group.js"></script>
</asp:Content>
    ...
    <div class="easyui-layout" fit="true"  style="padding:0px" >  
            ...
            <div  class="easyui-panel custom_bg" data-options="fit:true,border:false,title:''" style=" border-bottom:solid 1px #95b8e7;" >
                <table class="tab_std" style="width:auto;  ">
                    <tr>    
                        ...
                        <td class="value">
                            <select id="search_worker_user_typ" class="easyui-combobox" data-options="panelHeight:'auto',valueField:'value', textField:'label',filter: filterCombo,width:66" >
                             
                                <option value="1" selected >操作</option>
                        ...
                        <td class="value">
                             <input id="search_u_id" data-cu_id="" class="cls_customs_combogrid" style="width:172px;" /> 
                        </td>
                        ...
                        <td>
                            <a href="javascript:refresh_rpt_of_worker_group();" tabindex="1" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-query'">查询</a>
                            <a href="javascript:download_employee_group();" tabindex="1" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-20130406125519344_easyicon_net_16'">下载</a>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div data-options="region:'center',split:false,border:false" style="padding:0px"> 
            <div  class="easyui-panel" data-options="fit:true,border:false,title:''">
                <table id="tab_employee_group"></table>
            </div> 
        </div> 
    </div>
    <!--关联委托查看-->
