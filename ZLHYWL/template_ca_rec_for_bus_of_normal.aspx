<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="template_ca_rec_for_bus_of_normal.aspx.cs" Inherits="ZLHYWL.template_ca_rec_for_bus_of_normal" %>
...
<script src="Js/template_ca_rec_for_bus_of_normal.js"></script> 
...
<body style="width:100%;height:100%; overflow:hidden;  padding:0px; margin:0px;">
            ...
            <table class="tab_std " style="width:auto;  ">
                <tr> 
                    ...
                    <td class="value" colspan="3"> 
                        <input id="search_ca_cu_id" class="easyui-textbox" style="width:276px;height:24px;" />
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <a href="javascript:refresh_ca_list_by_normal_params();" tabindex="1" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-query'">查询</a>
    ...
    <!--账单费用查看-->
    <div id="win_woa_or_iv_order_fee" class="easyui-window"   title="" data-options="modal:false,inline:true,shadow:false,  closed:true,closeable:false, iconCls:'icon-save',fit:true,collapsible:false,minimizable:false,maximizable:false,draggable:false,resizable:false," style="padding:0px;overflow:hidden;">
		 
	</div>
    <!--核销记录-->
    <div id="window_of_write_off_accounts" class="easyui-window"   title="" data-options="modal:false,inline:true,shadow:false,  closed:true,closeable:true, iconCls:'icon-save',fit:true,collapsible:false,minimizable:false,maximizable:false,draggable:false,resizable:false," style="padding:0px;overflow:hidden;">
	    
    </div>
    <!--发票记录-->
    <div id="window_of_flag_invoice_list" class="easyui-window"   title="" data-options="modal:false,inline:true,shadow:false,  closed:true,closeable:true, iconCls:'icon-save',fit:true,collapsible:false,minimizable:false,maximizable:false,draggable:false,resizable:false," style="padding:0px;overflow:hidden;">
