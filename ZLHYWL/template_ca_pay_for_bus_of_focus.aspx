<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="template_ca_pay_for_bus_of_focus.aspx.cs" Inherits="ZLHYWL.template_ca_pay_for_bus_of_focus" %>
...
<script src="Js/template_ca_pay_for_bus_of_focus.js"></script> 
    ...
    <div class="easyui-layout" data-options="fit:true" style="padding:0px">
        <div data-options="region:'north',split:false,border:false" class="custom_bg" style=" border-bottom:solid 1px #95b8e7;height:32px;"> 
            <table class="tab_std" style="width:auto;  ">
                <tr> 
                    <td>
                        <a href="javascript:show_win_of_group_ca(1);" tabindex="1" class="easyui-linkbutton top_group_menu" data-options="plain:true,iconCls:'icon-query'">未交账</a> 
                    </td> 
                    <td>
                        <a href="javascript:show_win_of_group_ca(2);" tabindex="1" class="easyui-linkbutton top_group_menu" data-options="plain:true,iconCls:'icon-query'">待收票</a> 
                    </td>  
                    <td>
                        <a href="javascript:show_win_of_group_ca(4);" tabindex="1" class="easyui-linkbutton top_group_menu" data-options="plain:true,iconCls:'icon-query'">待交审</a> 
                    </td> 
