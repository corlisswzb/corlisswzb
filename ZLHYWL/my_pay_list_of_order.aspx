<%@ Page Title="" Language="C#" MasterPageFile="~/main_page.Master" AutoEventWireup="true" CodeBehind="my_pay_list_of_order.aspx.cs" Inherits="Jbfd.my_pay_list_of_order" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="Style/checkaccount.css" rel="stylesheet" />
    <script src="Js/operation_create_ca.js"></script>
    <script src="Js/my_pay_list_of_order.js"></script>
    <!--  
        两个页面，
        一个生成账单
        一个账单管理 
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="tabs_bar" >
        <span style="line-height:28px; padding-left:4px;padding-right:4px;"><b>当前位置:业务应付账单</b></span>
    </div>
    <div id="tabs_ca" class="easyui-tabs" data-options="fit:true,border:false,tools:'#tabs_bar',">
        ...
        <div title="应付账单列表">
            ...
            <div class="easyui-panel" data-options="title:'应付账单',border:false,fit:true">
    ...
    <!--账单费用查看-->
    <div id="win_woa_or_iv_order_fee" class="easyui-window" title="账单明细"  data-options="modal:true,zIndex:90, closed:true,iconCls:'icon-save',fit:true,collapsible:false,minimizable:false,maximizable:false,draggable:false,resizable:false," style="padding:0px;">
		 <div class="easyui-panel" id="ca_main_of_fee_details_panel" data-options="title:'账单明细',border:false,fit:true"> 
            <div class="easyui-layout" data-options="fit:true">
                <div data-options="region:'center',split:false,border:false">
    ...
    <div id="win_dv_view_of_approval_details_from_ca_list" class="easyui-menu" style="width: 240px; ">  
        ...
        <div  class="copy"   data-options="iconCls:'icon-view'" >复制账单备注</div>        
    </div> 
    <!--查看 审核流程-->
