<%@ Page Title="" Language="C#" MasterPageFile="~/main_page.Master" AutoEventWireup="true" CodeBehind="my_approval_of_pay_checkaccount.aspx.cs" Inherits="Jbfd.my_approval_of_pay_checkaccount" %>
                ...
                <div data-options="region:'north',title:'', split:false,border:false" class="custom_bg"  style="border-bottom:solid 1px #95b8e7;" >
                    <table class="tab_std" style="width:auto;  ">
                        <tr> 
                            ...
                            <td class="value"> 
                                <select id="search_ca_relation_c_id" class="easyui-combobox " data-options="panelHeight:'auto',panelWidth:'400',valueField:'value', textField:'label',filter: filterCombo,width:276" ></select>
                            </td> 
                        ...
                        <tr>
                            ...
                            <td class="value">
                                <%--<input id="search_od_delegate_cu_id" class="cls_customs_combogrid" style="width:172px;" />--%>
                                <select id="search_ca_cu_id" class="easyui-combobox cls_customs_combobox" data-options="width:276" >
                                   
                                </select>
                            </td>
                            <td class="title">申请年份:</td>
                            <td class="value"> 
                            ...
                            <td class="value">
                                <%--<input id="search_od_delegate_cu_id" class="cls_customs_combogrid" style="width:172px;" />--%>
                                <select id="search_ca_create_by_id" class="easyui-combobox cls_customs_combobox" data-options="width:106" >
                            ...
                            <td class="value">
                                <input type="checkbox" id="search_amc_hurry_flag" />
                            </td> 
                        ...
                        <tr>
                            ...
                            <td class="title">申请月份:</td>
                            <td class="value"> 
                                <select id="search_ca_month" class="easyui-combobox" data-options="panelHeight:'auto',valueField:'value', textField:'label',filter: filterCombo,width:106" ></select>
                            </td> 
                            <td class="title">
                                当前处理:
                            </td>
