<%@ Page Title="" Language="C#" MasterPageFile="~/main_page.Master" AutoEventWireup="true" CodeBehind="ld_query_order_group.aspx.cs" Inherits="SDZL.ld_query_order_group" %>
        ...
        <div data-options="region:'north',title:'', split:false,border:false" style="height:304px;" >
            <div data-options="fit:true" class="easyui-layout">
                <div data-options="region:'north',title:'', split:false,border:false" style="height:58px;" >
                    <div  class="easyui-panel custom_bg" data-options="fit:true,border:false,title:'领导查询-业务统计'" style="border-bottom:solid 1px #95b8e7;" >
